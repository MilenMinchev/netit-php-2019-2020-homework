...
Ajax.getJSON("http://localhost/staffing_agency/routes.php?endpoint=posts", function(data) {
...
//
//Ajax.getJSON("http://localhost/staffing_agency/routes.php?endpoint=groups", function(data) {
