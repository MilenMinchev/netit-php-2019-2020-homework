...
namespace db {
    ...
    class Database {
        ...
        // Шаблон за дизайн! Регистрация на Обект!
        ...
        //Прайвид методи могат да се използват само в рамките на Класа!
        ...
        /**
         * Return the number of affected from db rows
         * @author Mihail Petrov
         * @return number
         */
